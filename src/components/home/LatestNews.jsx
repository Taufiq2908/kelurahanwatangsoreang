          ...
          {featuredArticle && (
            <motion.div variants={fadeUpStaggerItemVariants} className="md:w-3/5 flex flex-col">
              ...
              >
                ...
                <h3 className="text-2xl md:text-3xl font-extrabold text-surface-900 leading-snug tracking-tight mb-2.5 group-hover:text-emerald-700 transition-colors duration-300 break-words">
                  {featuredArticle.title}
                </h3>
                <p className="text-sm text-surface-600 font-medium leading-relaxed line-clamp-2 break-words">
              ...
              <div className="space-y-8">
                {listArticles.map((article) => (
                  ...
                  >
                    ...
                    <h3 className="text-base font-extrabold text-surface-900 group-hover:text-emerald-700 transition-colors duration-300 leading-snug break-words">
                      {article.title}
                    </h3>
                  </Link>
                ))}
